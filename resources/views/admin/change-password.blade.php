                ...
                <div class="col-lg-12">
                    <div class="page-content my-account__edit">
                        <div class="my-account__edit-form">
                            <form name="account_edit_form" action="{{ route('admin.password.update') }}" method="POST"
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="password" placeholder="Mật khẩu hiện tại" name="current_password" tabindex="0"
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="password" placeholder="Xác nhận mật khẩu mới" name="new_password_confirmation"
                                        tabindex="0" value="" aria-required="true" required="">
                                </fieldset>
