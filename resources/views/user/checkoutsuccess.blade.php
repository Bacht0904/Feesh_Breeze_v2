        ...
        <section class="shop-checkout container">
            ...
            <div class="order-complete">
                ...
                <div class="order-info">
                    ...
                    <div class="order-info__item"><label>Ngày đặt</label>
                        <span>{{ \Carbon\Carbon::parse($order->order_date)->format('d/m/Y') }}</span>
                    </div>

                    <div class="order-info__item"><label>Tổng tiền</label> <span>{{ number_format($order->total, 0) }}
                            đ</span></div>
                    <div class="order-info__item"><label>Phương thức thanh toán</label>
                ...
                <div class="checkout__totals-wrapper mb-5">
                    ...
                    <div class="empty-products text-center py-5">
                        <a href="{{ route('shop') }}" class="btn mt-3"
                            style="color: white; background-color: #ff6f61; border-color: #ff6f61;">
                            Tiếp tục mua sắm
                        </a>
